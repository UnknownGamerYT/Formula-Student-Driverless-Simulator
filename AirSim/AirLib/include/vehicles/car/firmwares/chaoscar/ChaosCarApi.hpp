...
#ifndef msr_airlib_ChaosCarApi_hpp
#define msr_airlib_ChaosCarApi_hpp

#include "vehicles/car/api/CarApiBase.hpp"

namespace msr { namespace airlib {

class ChaosCarApi : public CarApiBase {
public:
    ChaosCarApi(const AirSimSettings::VehicleSetting* vehicle_setting, std::shared_ptr<SensorFactory> sensor_factory,
                const Kinematics::State& state, const msr::airlib::GeoPoint& home_geopoint)
    : CarApiBase(vehicle_setting, sensor_factory, state),
